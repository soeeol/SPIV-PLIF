...
plot(mf_PT_SJG, c_mg_PT_SJG_min, "k-.d;exp. @25°C UMS min. stirred GerkeSJxexp;");
plot(mf_PT_NK, csat_PT_NK,"-.x;exp. @22.5°C NogamiH1962et;");
plot(mf_Jetal, c_mg_Jetal,"-.o;exp. @25°C JordanJ1956etal;");
##plot(mf_Jetal, 2.1/1.6 *c_mg_Jetal,"-.o;JordanJ1956etal;");
##plot([0], csat_oxygen_water_T_model (T=TK(3), p_O2), "x; 25°C BensonBB1979etal;")
plot(mf_Retal, c_mg_Retal,"-.s;exp. @30°C RischbieterE1996etal;");
plot([0 mf_Ketal], c_mg_Ketal,"-.*;exp. @25°C KutscheI1984etal;");
##
...
plt_2_h = {mfilename, date; "mf_PT", "c_sat in mg/l; exp. @22.5°C NogamiH1962et"};
plt_2_d = [mf_PT_NK' csat_PT_NK'];
...
plt_3_h = {mfilename, date; "mf_PT", "c_sat in mg/l; exp. @25°C JordanJ1956etal"};
plt_3_d = [mf_Jetal' c_mg_Jetal'];
...
plt_4_h = {mfilename, date; "mf_PT", "c_sat in mg/l; exp. @30°C RischbieterE1996etal"};
plt_4_d = [mf_Retal' c_mg_Retal'];
...
plt_5_h = {mfilename, date; "mf_PT", "c_sat in mg/l; exp. @25°C KutscheI1984etal"};
plt_5_d = [[0 mf_Ketal]' c_mg_Ketal'];
...
plt_6_h = {mfilename, date; "mf_PT", "c_sat in mg/l;corr. @20°C RischbieterE1996etal"};
...
plt_7_h = {mfilename, date; "mf_PT", "c_sat in mg/l;corr. @25°C RischbieterE1996etal"};
...
plt_8_h = {mfilename, date; "mf_PT", "c_sat in mg/l;corr. @30°C RischbieterE1996etal"};
...
ylabel("saturation concentration O_2 in mg/l")
plot (mf_PD_NK, csat_PD_NK,"-.x;exp. @22.5°C NogamiH1962et;");
plot (mf_PD_Y, c_mg_Y,"-.x;exp. @25°C YamamotoH1994etal;");
...
plot (mf_PD_SJG, c_mg_PD_SJG_min, "-.ko;exp. @25°C UMS min. stirred GerkeSJxexp;")
...
plt_2_h = {mfilename, date; "mf_PD", "c_sat in mg/l; exp. @22.5°C NogamiH1962et"};
plt_2_d = [mf_PD_NK' csat_PD_NK'];
...
plt_3_h = {mfilename, date; "mf_PD", "c_sat in mg/l; exp. @25°C YamamotoH1994etal"};
plt_3_d = [mf_PD_Y' c_mg_Y'];
...
plt_4_h = {mfilename, date; "mf_PD", "c_sat in mg/l; exp. @25°C OsborneAD1965et"};
plt_4_d = [1' csat_PD_O'];
...
plt_5_h = {mfilename, date; "mf_PD", "c_sat in mg/l; water @20°C BensonBB1979etal"};
...
plt_6_h = {mfilename, date; "mf_PD", "c_sat in mg/l; water @25°C BensonBB1979etal"};
...
plt_7_h = {mfilename, date; "mf_PD", "c_sat in mg/l;Glycol corr. @25°C RischbieterE1996etal"};
