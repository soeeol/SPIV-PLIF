...
if 1
  ...
  delta_c_eq_1 = model_filmflow_laminar_deltac (x_c_eq', D_AB(1), u_s');
  delta_c_eq_2 = model_filmflow_laminar_deltac (x_c_eq', D_AB(2), u_s');
  ...
  beta_x_eq_1 = model_filmflow_laminar_beta_x (x_c_eq', D_AB(1), u_s)';
  beta_x_eq_2 = model_filmflow_laminar_beta_x (x_c_eq', D_AB(2), u_s)';
...
if 1
  ...
  beta_eq_1 = model_filmflow_laminar_beta (u_s, D_AB(1), L_eq')
  beta_eq_2 = model_filmflow_laminar_beta (u_s, D_AB(2), L_eq')
  beta_eq = beta_eq_2;

  beta_x_c_eq_1 = model_filmflow_laminar_beta_x (x_c', D_AB(1), u_s)';
  beta_x_c_eq_2 = model_filmflow_laminar_beta_x (x_c', D_AB(2), u_s)';
