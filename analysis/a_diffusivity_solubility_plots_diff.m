...
plt_5_d = [mf_PT_NK' D_PT_NK_T25' D_PT_NK_T25'./Dcorr_NK_PT'];
...
plt_7_d = [mf_Jetal' D_Jetal' D_Jetal'./Dcorr_Jetal'];
...
semilogy (mf, D_PT_SE, "k.-;Stokes-Einstein eq. (4 Pi);");
semilogy (mf, D_Am_PT_WC, "k-;Wike-Chang eq. mod. of Perkins and Geankoplis (1969);");
semilogy (mf, Dim_DM_PT, "k--;corr. w. MM (M. Diaz 1987);");
semilogy (mf, Dim_S_PT, "k-.;corr. w. MM (Sitaraman et al. 1963);");
semilogy (1, D_water_glycerol, "kd;exp. water (as solute) in glycerol (D'Errico et al. 2004);", "markersize", 5,"linewidth", 2)
semilogy (mf_PT_NK, D_PT_NK_T25,"ks;exp. (Nogami and Kato 1961);");
semilogy (mf_Jetal, D_Jetal, "ko;exp. D_F_i_c_k (Jordan et al. 1956);");
...
semilogy (mf, Dim_S_PT, "k-.;corr. w. MM (Sitaraman et al. 1963);");
semilogy (1, D_water_glycerol, "kd;exp. water (as solute) in glycerol (D'Errico et al. 2004);", "markersize", 5,"linewidth", 2)
semilogy (mf_PT_NK, D_PT_NK_T25./Dcorr_NK_PT,"ks;exp. (Nogami and Kato 1961);");
semilogy (mf_Jetal, D_Jetal./Dcorr_Jetal, "ko;exp. D_F_i_c_k (Jordan et al. 1956);");
semilogy (mf_SJG_PT, D_SJG_PT_1,"bs*;exp. this study, fist trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_SJG_PT, D_SJG_PT_2,"b+;exp. this study, second trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_PT_J, D_J_3_T25,"m*;exp. with 20% Ethanol (Jimenez et al. 2012) ;", "markersize", 5,"linewidth", 1.5);
semilogy (mf_PT_K, D_K_T25,"mo;exp. with 30% Ethanol (Kapoustina et al. 2019);", "markersize", 5,"linewidth", 2);
...
set (fh, "PaperSize", [fig_size_x fig_size_y]);
set (fh, "renderer", "painters");
semilogy (mf, D_PT_SE*D_W_exp_mean/D_PT_SE(1), "k.-;Stokes-Einstein eq. (4 Pi);");
semilogy (mf, D_Am_PT_WC*D_W_exp_mean/D_Am_PT_WC(1), "k-;Wike-Chang eq. mod. of Perkins and Geankoplis (1969);");
semilogy (mf, Dim_DM_PT*D_W_exp_mean/Dim_DM_PT(1), "k--;corr. w. MM (M. Diaz 1987);");
semilogy (mf, Dim_S_PT*D_W_exp_mean/Dim_S_PT(1), "k-.;corr. w. MM (Sitaraman et al. 1963);");
semilogy (1, D_water_glycerol, "kd;exp. water (as solute) in glycerol (D'Errico et al. 2004);", "markersize", 5,"linewidth", 2)
semilogy (mf_PT_NK, D_PT_NK_T25./Dcorr_NK_PT*D_W_exp_mean/(D_PT_NK_T25(1)./Dcorr_NK_PT(1)),"ks;exp. (Nogami and Kato 1961);");
semilogy (mf_Jetal, D_Jetal./Dcorr_Jetal * D_W_exp_mean /(D_Jetal(1) ./ Dcorr_Jetal(1)), "ko;exp. D_F_i_c_k (Jordan et al. 1956);");
semilogy (mf_SJG_PT, D_SJG_PT_1,"bs*;exp. this study, fist trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_SJG_PT, D_SJG_PT_2,"b+;exp. this study, second trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_PT_J, D_J_3_T25,"m*;exp. with 20% Ethanol (Jimenez et al. 2012) ;", "markersize", 5,"linewidth", 1.5);
semilogy (mf_PT_K, D_K_T25,"mo;exp. with 30% Ethanol (Kapoustina et al. 2019);", "markersize", 5,"linewidth", 2);
...
plt_5_d = [mf_PD_NK' D_PD_NK_T25' D_PD_NK_T25'./Dcorr_NK_PD'];
...
semilogy (mf, D_Am_PD_WC, "k-;Wike-Chang eq. mod. of Perkins and Geankoplis (1969);");
semilogy (mf, Dim_DM_PD, "k--;corr. w. MM (M. Diaz 1987);");
semilogy (mf, Dim_S_PD, "k-.;corr. w. MM (Sitaraman et al. 1963);");
semilogy (mf_PD_NK, D_PD_NK_T25,"ks;exp. (Nogami and Kato 1961);");
semilogy (mf_SJG_PD, D_SJG_PD_1,"bs*;exp. this study, fist trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_SJG_PD, D_SJG_PD_2,"b+;exp. this study, second trend;", "markersize", 8, "linewidth", 1.5);
...
semilogy (mf, Dim_DM_PD, "k--;corr. w. MM (M. Diaz 1987);");
semilogy (mf, Dim_S_PD, "k-.;corr. w. MM (Sitaraman et al. 1963);");
semilogy (mf_PD_NK, D_PD_NK_T25./Dcorr_NK_PD,"ks;exp. (Nogami and Kato 1961);");
semilogy (mf_SJG_PD, D_SJG_PD_1,"bs*;exp. this study, fist trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_SJG_PD, D_SJG_PD_2,"b+;exp. this study, second trend;", "markersize", 8, "linewidth", 1.5);
xlabel ("mass fraction Propylene Glycol in g/g")
ylabel ("D in m^2/s")
...
set (fh, "PaperSize", [fig_size_x fig_size_y]);
set (fh, "renderer", "painters");
semilogy (mf, D_PD_SE*D_W_exp_mean/D_PD_SE(1), "k.-;Stokes-Einstein eq. (4 Pi);");
semilogy (mf, D_Am_PD_WC*D_W_exp_mean/D_Am_PD_WC(1), "k-;Wike-Chang eq. mod. of Perkins and Geankoplis (1969);");
semilogy (mf, Dim_DM_PD*D_W_exp_mean/Dim_DM_PD(1), "k--;corr. w. MM (M. Diaz 1987);");
semilogy (mf, Dim_S_PD*D_W_exp_mean/Dim_S_PD(1), "k-.;corr. w. MM (Sitaraman et al. 1963);");
semilogy (mf_PD_NK, D_PD_NK_T25./Dcorr_NK_PD*D_W_exp_mean/(D_PD_NK_T25(1)./Dcorr_NK_PD(1)),"ks;exp. (Nogami and Kato 1961);");
semilogy (mf_SJG_PD, D_SJG_PD_1,"bs*;exp. this study, fist trend;", "markersize", 8, "linewidth", 1.5);
semilogy (mf_SJG_PD, D_SJG_PD_2,"b+;exp. this study, second trend;", "markersize", 8, "linewidth", 1.5);
xlabel ("mass fraction Propylene Glycol in g/g")
ylabel ("D in m^2/s")
